...
\begin{document}
	...
	\chapter{Ejercicios autónomos}
		...
		\section{Descripción de los datos}\label{sec:descrip_auto}
			...
			Prosiguiendo con el análisis de datos, se debe que obtener la media aritmética del conjunto de datos. Para ello, se propone la siguiente función, la cual va a sumar todos los elementos de la muestra, y ese resultado se divide entre el número total de elementos de la muestra.
			...
			En caso de tener un número de elementos par, se cogerá de la lista ordenada el elemento $\frac{n}{2}$ y el elemento $\frac{n}{2} + 1$, se sumarán y se dividirá el resultado entre dos. En caso de tener un número de elementos impar directamente se tendrá que coger el elemento $\frac{n+1}{2}$.\\
