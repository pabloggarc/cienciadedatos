...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{apriori} \hlkwb{=} \hlkwa{function}\hlstd{(}\hlkwc{table}\hlstd{,} \hlkwc{elements}\hlstd{,} \hlkwc{s}\hlstd{,} \hlkwc{c}\hlstd{) \{}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{elements} \hlkwb{=} \hlkwd{c}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"X"}\hlstd{),} \hlkwd{c}\hlstd{(}\hlstr{"A"}\hlstd{) ,}\hlkwd{c}\hlstd{(}\hlstr{"T"}\hlstd{),} \hlkwd{c}\hlstd{(}\hlstr{"N"}\hlstd{),} \hlkwd{c}\hlstd{(}\hlstr{"B"}\hlstd{),} \hlkwd{c}\hlstd{(}\hlstr{"C"}\hlstd{))}

\hlstd{tabla} \hlkwb{=} \hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}
        \hlnum{1}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}
        ...
        \hlnum{1}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}
        \hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{),}\hlnum{8}\hlstd{,}\hlnum{6}\hlstd{,}\hlkwc{byrow}\hlstd{=}\hlnum{TRUE}\hlstd{,}\hlkwc{dimnames}\hlstd{=}\hlkwd{list}\hlstd{(}
\hlkwd{c}\hlstd{(}\hlstr{"occu1"}\hlstd{,}\hlstr{"occu2"}\hlstd{,}\hlstr{"occu3"}\hlstd{,}\hlstr{"occu4"}\hlstd{,}\hlstr{"occu5"}\hlstd{,}\hlstr{"occu6"}\hlstd{,}\hlstr{"occu7"}\hlstd{,}\hlstr{"occu8"}\hlstd{),}
\hlkwd{c}\hlstd{(}\hlstr{"X"}\hlstd{,} \hlstr{"A"}\hlstd{,} \hlstr{"T"}\hlstd{,} \hlstr{"N"}\hlstd{,} \hlstr{"B"}\hlstd{,} \hlstr{"C"}\hlstd{)))}

\hlkwd{apriori}\hlstd{(tabla, elements,} \hlnum{0.4}\hlstd{,} \hlnum{0.9}\hlstd{)}
\end{alltt}
\begin{verbatim}
##   left right
## 1    B     X
