...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{transacciones} \hlkwb{=} \hlkwd{as}\hlstd{(traspmuestrangCMatrix,} \hlstr{"transactions"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): objeto 'traspmuestrangCMatrix' no encontrado}}\begin{alltt}
\hlstd{transacciones}
\end{alltt}
