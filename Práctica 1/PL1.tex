...
\end{knitrout}
			...
			Tras haber codificado las medidas de tendencia central, vamos a estudiar dos medidas de dispersión. \\
			
			La primera de las medidas que vamos a calcular es la desviación típica. Para ello hemos codificado la siguiente función:
