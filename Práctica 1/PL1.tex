...
\end{knitrout}
			...
			Las dos siguientes son \texttt{cabeza} y \texttt{cola}. Dada una lista y un valor natural, \texttt{cabeza} devuelve otra lista que es una partición de la original hasta el índice del valor indicado. De la misma forma, \texttt{cola} devuelve la lista que contiene los últimos valores indicados. Ambas funciones hacen uso de las funciones \texttt{head} y \texttt{tail} respectivamente, pero devolviendo \texttt{NULL} si el numero de elementos a seleccionar es menor o igual a 0.
