...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: <text>:8:0: unexpected end of input\\\#\# 6: for (k in 1:(i-1)) \{ \#itera posibilidades que haya en el lado izquierdo; -1 es para quitar los conjuntos vacios; numero de elementos que hay a la izq de la implic\\\#\# 7: \\\#\# \ \ \textasciicircum{}}}\end{kframe}
\end{knitrout}
